...
import { FileWordOutlined, DownloadOutlined, PrinterOutlined } from "@ant-design/icons";
...
const files = [
  <>
  	<Text type="secondary"> <FileWordOutlined />	Файл содержания.docx</Text>
  	<Button
     type="primary"
	        	...
	        	<div className="defaultForm">
		        	<div id="print-section">
			        	<div className="defaultForm__tile">
		        			<Title level={3} style={{ color: "#0e78ff" }}>{checklist.name}</Title>
		        			<Text type="secondary">Версия чек-листа: {checklist.versionChecklistId}</Text>
		        		</div>
