...
const files = [
  <>
  	<Text type="secondary"> <FileWordOutlined />	Header.docx</Text>
  	<Button
     type="primary"
  ...
  <>
  	<Text type="secondary"> <FileWordOutlined />	Comment.docx</Text>
  	<Button
     type="primary"
     icon={<DownloadOutlined />}
     >
	        ...
	        <div className="container">
	        	<div className="defaultForm">
	        		<div className="defaultForm__tile">
	        			<Title level={3} style={{ color: "#0e78ff" }}>Версия № {version.id}</Title>
	        			{
	        				version.actualKey == "Не актуально" ?
	        				<Text type="secondary">Ключ акртуальности: {version.actualKey}</Text> :
	        				<div style={{ display: "flex" }}>
	        					<Text type="secondary">Ключ акртуальности: </Text>
	        					<Text type="success" style={{ paddingLeft: "5px" }}> {version.actualKey} <CheckOutlined /></Text>
	        				</div>
 	        			}
	        		</div>
