...
import { List, Typography, Button, Collapse, Divider, Skeleton, message } from "antd";
import {
  FileWordOutlined,
  DownloadOutlined,
  CheckOutlined,
...
import { fetchOneVersion, downloadHeaderFile, downloadCommentFile } from "../http/versionChecklistAPI";
                  ...
                  >
                    <List.Item>
                    {
                      ...
                      <>
                        ...
                        <Button type="primary" icon={<DownloadOutlined />} onClick={downloadHeader}>
                          Скачать
                        </Button>
                      </> :
                      <>
                    ...
                    <List.Item>
                    {
                      ...
                      <>
                        ...
                        <Button type="primary" icon={<DownloadOutlined />} onClick={downloadComment}>
                          Скачать
                        </Button>
                      </> :
                      <>
